  /**
 * DEPRECATED: Layout wrapper replaced by direct ICUIBaseHeader + ICUILayout usage in Home.
 * Kept only for reference and older tests. Do not import in new code.
 */
