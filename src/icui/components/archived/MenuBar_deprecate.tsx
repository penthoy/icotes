/**
 * DEPRECATED: ICUI Menu Bar Component (archived)
 *
 * Home uses ICUIBaseHeader's built-in menus. This component remains for
 * experiments/tests and potential future advanced menus. Avoid wiring it into
 * Home to prevent duplicate menus.
 */
