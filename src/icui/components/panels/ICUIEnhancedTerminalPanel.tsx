...
export const ICUIEnhancedTerminalPanel: React.FC<ICUIEnhancedTerminalPanelProps> = ({ className = '' }) => {
  ...
  useEffect(() => {
    ...
    terminal.current = new Terminal({
      ...
      theme: {
        background: isDarkTheme ? 'var(--icui-bg-primary)' : '#ffffff',
        foreground: isDarkTheme ? 'var(--icui-text-primary)' : '#000000',
        cursor: isDarkTheme ? 'var(--icui-text-primary)' : '#000000',
        cursorAccent: isDarkTheme ? 'var(--icui-bg-primary)' : '#ffffff',
        selectionBackground: 'var(--icui-accent)',
        black: '#000000',
        brightBlack: isDarkTheme ? '#666666' : '#444444',
        red: isDarkTheme ? '#cd3131' : '#a31515',
        brightRed: isDarkTheme ? '#f14c4c' : '#cd3131',
        green: isDarkTheme ? '#0dbc79' : '#00a000',
        brightGreen: isDarkTheme ? '#23d18b' : '#008000',
        yellow: isDarkTheme ? '#e5e510' : '#a08000',
        brightYellow: isDarkTheme ? '#f5f543' : '#808000',
        blue: isDarkTheme ? '#2472c8' : '#0451a5',
        brightBlue: isDarkTheme ? '#3b8eea' : '#0066cc',
        magenta: isDarkTheme ? '#bc3fbc' : '#a020f0',
        brightMagenta: isDarkTheme ? '#d670d6' : '#800080',
        cyan: isDarkTheme ? '#11a8cd' : '#0598bc',
        brightCyan: isDarkTheme ? '#29b8db' : '#008080',
        white: isDarkTheme ? '#e5e5e5' : '#666666',
        brightWhite: isDarkTheme ? '#ffffff' : '#333333',
      },
    });
